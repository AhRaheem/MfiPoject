...
namespace Infrastructure.Repository
{
	public class PostRepository : GenericRepository<IApplicationDbContext, Post>, IPostRepository
	{
        ...
        public async Task CreatePostParagraph(PostParagraph Model)
        {
        ...
        public async Task DeletePostParagraph(PostParagraph Entity)
        {
            Entity.IsDeleted = true;
            Entity.DeletedOn = DateTime.Now;
        ...
        public async Task<PostParagraph> GetParagraphById(string Id)
        {
            return await _dbContext.PostParagraphs.FirstOrDefaultAsync(x => x.Id == Id);
        }

        public async Task<PostParagraph> GetParagraphByNameAr(string Name)
        {
            return await _dbContext.PostParagraphs.FirstOrDefaultAsync(x => x.TitleAr == Name);
        }

        public async Task<PostParagraph> GetParagraphNameEn(string Name)
        {
            return await _dbContext.PostParagraphs.FirstOrDefaultAsync(x => x.TitleEn == Name);
        }

        public async Task<IEnumerable<PostParagraph>> GetParagraphs(string PostId)
        {
        ...
        public async Task UpdatePostParagraph(PostParagraph Entity)
        {
