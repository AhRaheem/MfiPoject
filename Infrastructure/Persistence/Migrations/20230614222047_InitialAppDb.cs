        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsNewsEditor = table.Column<bool>(type: "bit", nullable: false),
                    IsNewsPublisher = table.Column<bool>(type: "bit", nullable: false),
                    IsGalleryEditor = table.Column<bool>(type: "bit", nullable: false),
                    IsGalleryPublisher = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RelatedWebsites", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PartnerCategoryId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    FileId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NameAr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NameEn = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostAffiliateLaws", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostAffiliateLaws_PostId",
