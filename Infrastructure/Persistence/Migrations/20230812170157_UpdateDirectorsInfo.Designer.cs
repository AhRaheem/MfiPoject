...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230812170157_UpdateDirectorsInfo")]
    partial class UpdateDirectorsInfo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entites.AboutUs", b =>
                {
                    ...
                    b.Property<string>("CeoNameAr")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CeoNameEn")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ChairmanAr")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Core.Entites.Protocol", b =>
                {
                    b.HasBaseType("Core.Entites.Base.Post");
            ...
            modelBuilder.Entity("Core.Entites.PostArticleParagraph", b =>
                {
                    ...
                    b.HasOne("Core.Entites.Protocol", null)
                        .WithMany("PostArticleParagraphs")
